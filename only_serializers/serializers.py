...
# Global level validations (It is outside of the class)
...
#============================This below part is only_serializers===========================
...
# 		return Employee.objects.create(**validated_data) # this validated_data is the database supported
