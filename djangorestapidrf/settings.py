"""
Django settings for djangorestapidrf project.
...
SECRET_KEY = 'kjlmfpn^zx5%!yi*=*=3+f0b+!m^dnd(r4wju!hb=00bc%=v^@'
...
ROOT_URLCONF = 'djangorestapidrf.urls'
...
WSGI_APPLICATION = 'djangorestapidrf.wsgi.application'
